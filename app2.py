    ...
    try:
        ...
        for attempt in range(max_attempts):
            ...
            intro = generate_gpt_text(
                intro_prompt,
                max_new_tokens=150,  # Increased for more technical detail
                model=gpt_model,
...
def chat():
    ...
    try:
        ...
        if not data:
            ...
            return jsonify({'response': "I’m sorry, I couldn’t understand your question. Could you please provide more details? I’m here to help with information about your X-ray analysis or vital signs."})
        ...
        prediction = data.get('prediction', 'Unknown') if data else 'Unknown'
        confidence = data.get('confidence', 0.0) if data else 0.0
        vital_signs = data.get('vital_signs', {}) if data else {}
        response = (
            f"I'm sorry, I had trouble processing your question, but I can still help with some information. "
